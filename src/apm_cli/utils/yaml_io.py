...
def dump_yaml(
    ...
    *,
    ...
    The file is written with deterministic LF line endings (``newline=""``
    disables platform newline translation). Several callers rewrite
    ``apm.yml`` INSIDE an installed package tree that
